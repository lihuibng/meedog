...
public class UserFoodTravelConcertSportStory implements Serializable {
    @ApiModelProperty(value = "user food travel concert sport story")
    private Long id;

    @ApiModelProperty(value = "food travel concert sport id")
